var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        var oTable = table.dataTable({
            ...
            "tableTools": {
                "sSwfPath": "/app/symfony/web/assets/global/plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf",
                "aButtons": [{
                    "sExtends": "pdf",
                    "sButtonText": "PDF",
                    "sTitle" : $('#msg').val(),
                    "sFileName" : $('#msg').val() + ".pdf",
                     "mColumns": [0, 1, 2, 3]
                }, {
                    "sExtends": "csv",
                    "sButtonText": "CSV",
                    "sTitle" : $('#msg').val(),
                    "sFileName" : $('#msg').val() + ".csv",
                     "mColumns": [0, 1, 2, 3]
                }, {
                    "sExtends": "xls",
                    "sButtonText": "Excel",
                    "sTitle" : $('#msg').val(),
                    "sFileName" : $('#msg').val() + ".xls",
                     "mColumns": [0, 1, 2, 3]
                }, {
                   "sExtends": "print",
                    "sButtonText": "Print",

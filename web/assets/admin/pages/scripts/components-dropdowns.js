var ComponentsDropdowns = function () {
    ...
    var handleSelect2 = function () {
        ...
        function format(state) {
            ...
            return "<img class='flag' src='{{ asset(\'assets/global/img/flags/" + state.id + ".png\')}}'/>&nbsp;&nbsp;" + state.text;
        }
    ...
    var handleSelect2Modal = function () {
        ...
        function format(state) {
            if (!state.id) return state.text; // optgroup
            return '<img class="flag" src="/app/symfony/web/assets/global/img/flags/'+state.id+'.png"/>'+'&nbsp;&nbsp;' + state.text;
        }

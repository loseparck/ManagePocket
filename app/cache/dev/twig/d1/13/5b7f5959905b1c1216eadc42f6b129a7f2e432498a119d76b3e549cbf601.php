...
/* myPocketBundle:public:listerevenu.html.twig */
class __TwigTemplate_d1135b7f5959905b1c1216eadc42f6b129a7f2e432498a119d76b3e549cbf601 extends Twig_Template
{
...
<html>
    ...
    <body class=\"page-md page-sidebar-closed-hide-logo page-container-bg-solid page-sidebar-closed-hide-logo page-header-fixed page-sidebar-fixed\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["revenus"]) ? $context["revenus"] : $this->getContext($context, "revenus")));
        foreach ($context['_seq'] as $context["_key"] => $context["revenu"]) {
            // line 99
            echo "                                                <tr>
                                                    <td>";
            // line 100
            echo twig_escape_filter($this->env, $this->getAttribute($context["revenu"], "designation", array()), "html", null, true);
            echo "</td>
                                                    <td>";
            // line 101
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($context["revenu"], "date", array()), "d-m-Y"), "html", null, true);
            echo "</td>
                                                    <td>";
            // line 102
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($context["revenu"], "categorie", array()), "nom", array()), "html", null, true);
            echo "</td>
                                                    <td>";
            // line 103
            echo twig_escape_filter($this->env, $this->getAttribute($context["revenu"], "montant", array()), "html", null, true);
            echo "</td>
                                                    <td>
                                                        <button class=\"btn btn-danger\" data-toggle=\"modal\" onclick=\"document.getElementById('idr').value=";
            // line 105
            echo twig_escape_filter($this->env, $this->getAttribute($context["revenu"], "id", array()), "html", null, true);
        ...
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['revenu'], $context['_parent'], $context['loop']);
        ...
        echo "                                        </tbody>
                    ...
                    <input type=\"hidden\" id=\"msg\" value=\"liste des revenus du mois ";
        // line 121
        echo twig_escape_filter($this->env, (isset($context["m"]) ? $context["m"] : $this->getContext($context, "m")), "html", null, true);
        echo "-";
        echo twig_escape_filter($this->env, (isset($context["y"]) ? $context["y"] : $this->getContext($context, "y")), "html", null, true);
    ...
    {
        return "myPocketBundle:public:listerevenu.html.twig";
    }

...
namespace Proxies\__CG__\myPocketBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class categorie extends \myPocketBundle\Entity\categorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'myPocketBundle\\Entity\\categorie' . "\0" . 'id', '' . "\0" . 'myPocketBundle\\Entity\\categorie' . "\0" . 'nom', '' . "\0" . 'myPocketBundle\\Entity\\categorie' . "\0" . 'photo', 'revenu', 'depense');
        }
    ...
    public function addRevenu(\myPocketBundle\Entity\revenu $revenu)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addRevenu', array($revenu));

        return parent::addRevenu($revenu);
    }
    ...
    public function getRevenu()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRevenu', array());
    ...
    public function addDepense(\myPocketBundle\Entity\depense $depense)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addDepense', array($depense));

        return parent::addDepense($depense);
    }
